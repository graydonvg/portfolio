...
export const EARTH_DELAY_IN_SEC = TOTAL_PRELOADER_TRANSITION_DURATION_IN_SEC;
export const LIGHT_BEAM_DELAY_IN_SEC = PRELOADER_TRANSITION_DELAY_IN_SEC + 0.1;
export const STARS_DELAY_IN_SEC = PRELOADER_TRANSITION_DELAY_IN_SEC;
export const SHOOTING_STAR_DELAY_IN_MS =
  TOTAL_PRELOADER_TRANSITION_DURATION_IN_SEC * 1000 + 2000;
export const HERO_DELAY_IN_SEC = TOTAL_PRELOADER_TRANSITION_DURATION_IN_SEC + 1;
export const HEADER_DELAY_IN_SEC =
  TOTAL_PRELOADER_TRANSITION_DURATION_IN_SEC + 1;
